        ...
        <div class="col-md-10 text-center">
          <?php
            ...
            if(isset($_POST['submit'])){
              ...
              $Query = mysqli_query($con, "INSERT INTO Alunos (mat, nome, cpf,datanasc) VALUES ('$mat', '$nome','$cpf', '$datanasc')");
              if($Query){
                ...
                <div class="modal-body">
                  <form method="POST" action="">
                    <div class="form-group">
                      <input type="text" name="mat" class="form-control" placeholder="Matricula..." required="">
                    </div><!-- form-group -->
                    <div class="form-group">
